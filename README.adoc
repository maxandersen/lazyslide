...
[.lead]
A small JBang tool for writing presentations in AsciiDoc and rendering them to reveal.js.
...
[source,bash]
----
./jbang lazyslide/lazyslide.java render
----
...
[source,bash]
----
./jbang lazyslide/lazyslide.java render index.adoc
----
...
[source,bash]
----
./jbang lazyslide/lazyslide.java render docs/
----
...
[source,bash]
----
./jbang lazyslide/lazyslide.java serve
----
...
- show the TamboUI dashboard

== Bootstrap a new presentation

[source,bash]
----
./jbang lazyslide/lazyslide.java init ../my-talk --title "My Talk" --author "Your Name"
----
...
- `lazyslide.java` — the tool itself
- `jbang-catalog.json` — alias metadata for `lazyslide`
- `README.adoc` — this document, readable as text or renderable as slides

== Render this README as slides

[source,bash]
----
./jbang lazyslide/lazyslide.java lazyslide/README.adoc
----

Or from inside `lazyslide/`:

[source,bash]
----
../jbang lazyslide.java README.adoc
----

== Short-name setup

Because the script file is named `lazyslide.java`, the command name is simply `lazyslide`.
You can also expose it through a JBang alias or catalog entry using `jbang-catalog.json`.

== Why AsciiDoc for a README?

- The file is still readable in plain text
- It doubles as a small slide deck
- The same authoring style is used for docs and talks
- It demonstrates the tool using the tool

== Next steps

- tune the TUI layout further
- add publishing helpers
- add PDF export workflows
